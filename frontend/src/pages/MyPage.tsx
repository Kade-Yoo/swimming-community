...
const MyPage: React.FC = () => {
  ...
  const achievements = [
    { title: '첫 대회 참가', icon: 'ri-trophy-line', date: '2023-11-15', description: '첫 번째 대회에 참가했습니다' },
    { title: '자유형 마스터', icon: 'ri-medal-line', date: '2023-12-20', description: '자유형 100m 기록 달성' },
    { title: '커뮤니티 활동가', icon: 'ri-community-line', date: '2024-01-10', description: '100개 이상의 게시글 작성' },
    { title: '기록 달성', icon: 'ri-time-line', date: '2024-01-15', description: '개인 최고 기록 갱신' }
  ];
          ...
          <div className="flex border-b border-gray-200 px-2 pt-2 overflow-x-auto">
            {tabs.map((tab) => (
              <button
                ...
                className={`relative flex-shrink-0 px-6 py-4 text-center font-medium transition-colors cursor-pointer whitespace-nowrap bg-transparent ${
                  activeTab === tab.id
                    ? 'text-blue-600'
            ...
            {activeTab === 'records' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/records" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer whitespace-nowrap">
                    기록 관리
                  </Link>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
